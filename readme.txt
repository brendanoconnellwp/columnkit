...
= 0.6.2 =
* Fixed: "Check again" on Dashboard → Updates now forces a fresh GitHub release lookup instead of serving the updater's cached result (up to 6h old — or a cached failed lookup on private repos without a token).
